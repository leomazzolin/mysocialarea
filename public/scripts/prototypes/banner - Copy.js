...
Banner.prototype = {
	...
	setText: function()
	{
		if (this.type == 'logo')
		{
			...
			this.context.fillText("My", 10, this.fontsize+8);
			this.context.strokeText("My", 10, this.fontsize+8 );
			this.context.fillText("SocialArea", 10, 2*(this.fontsize+10));
			this.context.strokeText("SocialArea", 10, 2*(this.fontsize+10));
			this.context.fillText(".com", 75, 3*(this.fontsize+10));
			this.context.strokeText(".com", 75, 3*(this.fontsize+10));
		}
		if (this.type == 'logo1')
		{
			this.context.font = this.fontsize + this.fontsetting;
