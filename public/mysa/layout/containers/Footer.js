...
return declare(null, {
	...
	errorInfo: {
				class: "layout/containers/Footer",
				},
	element: null,
	dim: new Object(),
	...
	constructor: function(){
		...
		try{
			...
			this.element = domConstruct.create("div", {	
												id: "l-footer",
												class: "pos-absolute",
												innerHTML: "<p style='padding: 0 10px 0 10px;'>&copy;2014 MySocialArea.com</p>",
												style: "color: white; height: 30px; background-color: blue; margin-bottom: 10px;"
												}, "l-page-layout");
		}
		catch(e){
