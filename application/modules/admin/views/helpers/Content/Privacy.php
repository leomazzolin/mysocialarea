<?php
class Zend_View_Helper_Content_Privacy extends Zend_View_Helper_Abstract
{
    public function Content_Privacy ()
    { ?>
        <h2>Privacy Policy</h2>
        <p>mysocialarea.com</p>
        <p>Effective and Last Updated: 2013-JANUARY-28</p>
        <p>
        This website is owned and operated by G3RD WEBSITES.  We are committed to protecting the privacy of our visitors while they interact with the content, products and services on this site (the &quot;Site&quot;).  This Privacy Policy applies to the Site only. It does not apply to other websites to which we link.  Because we gather certain types of information about our users, we want you to understand what information we collect about you, how we collect it, how that information is used, and how you can control our disclosure of it. You agree that your use of the Site signifies your assent to this Privacy Policy. If you do not agree with this Privacy Policy, please do not use the Site.
        </p>
        ...
        &bull;     Voluntary Registration Information. </p><p>
        ...
        By registering with us, you consent to the use and method of disclosure as described in this Privacy  Policy.</p><p>
        <p>
        &bull;    Cookies
        </p>
        <p>
        Our site uses &quot;cookies&quot; and other tracking technologies.  Cookies enable us to serve secure pages to our users without asking them to sign in repeatedly.  Most browsers allow you to control cookies, including whether or not to accept them and how to remove them. If a user&rsquo;s system is idle for a defined time, the cookie will expire, forcing the user to sign in again to continue their session. This prevents unauthorised access to the user&rsquo;s information while they are away from their computer. 
        </p>
        <p>
        ...
        <h3>2)  Referrals</h3>
        <p>
        You may choose to invite friends to join the mysocialarea.com by sending invitation emails via our invite feature. mysocialarea.com stores the email addresses you provide so that the respondents may be added to your social network, confirm orders/purchases and also to send reminders of the invitations. mysocialarea.com does not sell these email addresses or use them to send any other communication besides invitations and invitation reminders. Recipients of invitations may contact mysocialarea.com to request removal of their information from our database. 
        </p>  
        <h3>3)  How We Use Your Information</h3>
        <p>
        mysocialarea.com only uses your personal information for the original purposes it was given. Your personal information will not be sold or otherwise transferred to unaffiliated third parties without your approval at the time of collection.
        </p>
        <p>
        mysocialarea.com will not disclose, use, give or sell any personal information to third parties for any purposes other than to our suppliers and other third parties who need to know in order to deliver services on behalf of mysocialarea.comunless required to do so by law. Further, mysocialarea.com reserves the right to contact you regarding matters relevant to the underlying service provided and/or the information collected.
        </p>
        <p>
        ...
        <p>
        mysocialarea.com may use your personal information for target advertising toward you based on things such as region, gender, interests, goals, habits, etc.
        </p>
        <p>
        ...
        <p>
        WE ARE NOT LIABLE OR RESPONSIBLE FOR THE PERSONALLY IDENTIFIABLE OR OTHER INFORMATION YOU CHOOSE TO SUBMIT IN FORUMS AND SOCIAL PLUGINS SUCH AS A BULLETIN BOARD, CHAT ROOM, TWITTER AND FACEBOOK SOCIAL PLUGINS FOUND ON THE SHOUT OUT CENTRAL PART OF THE mysocialarea.com WEBSITE OR ANY OTHER PUBLICLY ACCESSIBLE AREA OF THE SITE.
         </p>
        <p>
        ...
        <p>
        Advertisements appearing on this Site may be delivered to you by mysocialarea.com or one of our Web advertising partners. Our Web advertising partners may set cookies. Doing this allows the advertising partners to recognise your computer each time they send you an advertisement. In this way, they may compile information about where you, or others who are using your computer, saw their advertisements and determine which advertisements are clicked. This information allows an advertising partner to deliver targeted advertisements that they believe will be of most interest to you. mysocialarea.com does not have access to or control of the cookies that may be placed by the third party advertising servers of ad partners.   
        </p>
        <p>
        This privacy statement covers the use of cookies by mysocialarea.com and does not cover the use of cookies by any of its advertisers.  
        </p>
        <h3>6) Accessing and Updating Your Personal Information and Preferences</h3>
        <p>
        We provide mechanisms for updating and correcting your personal information for many of our services.  If you are a registered user, you may access and update your registration information and your preferences to receive email or other communications from us by sending an email to customerservice@mysocialarea.com. 
        </p>
        <h3>7) Email Choice/Opt-out</h3>
        <p> 
        If any user who receives an email from the Site and would prefer not to receive such communications in the future, [he or she] can do so by following the instructions in the emails.  In addition, you may send an email to customerservice@mysocialarea.com. We will make commercially reasonable efforts to implement your opt-out requests promptly, but you may still receive communications from us for up to ten business days as we process your request.
        </p>
        <h3>8) Children&rsquo;s Privacy and Parental Controls</h3>
        <p>
        ...
        <h3>9) Disclaimer to Security</h3>
        <p>
        ...
        <h3>10) Notification of Changes</h3>
        <p>
