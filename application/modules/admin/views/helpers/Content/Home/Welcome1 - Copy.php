...
class Zend_View_Helper_Content_Home_Welcome1 extends Zend_View_Helper_Abstract
{
    public function Content_Home_Welcome1($key)
    {
		...
		$output['pss'] =
			'
			<p>
			Pets have come along way from not even being allowed into the house to sleeping in their master&apos;s bed, having their own wardrobe and in many 
			cases having more money spent on them then their master&apos; children. So now it&apos;s time to take your pet from the oh so 2000 and late scene all the way to 
			2000 and oh so great scene by giving your pet their very own social presence!
			</p>
			<br />
        	<a class="menu-item" href="/default/pss/index">Go to PET SOCIAL SPACE</a>
			';
		return $output[$key];
    }
}
