...
class Admin_Form_Filter_Question extends Zend_Dojo_Form
{
    public function init()
    {
		...
		*/
		...
		$e['context'] = new Zend_Dojo_Form_Element_ComboBox('context');
		$e['context']->setLabel('Context:');
		$e['context']->setRequired(true);
		$e['context']->setOptions(array('invalidMessage' => 'Invalid context specified.'));
		$e['context']->setAutoComplete('true');
		$e['context']->setMultiOptions(array('all' => 'All', '2012' => '2012', '2013' => '2013'));
